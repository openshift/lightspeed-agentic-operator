...
- `spec.tools` as the run-level tools source for every step [DONE: OLS-4060]
...
- [DONE: OLS-4060] Removed per-step tool definitions; `AgenticRun.spec.tools` supplies MCP servers, skills, and required secrets to all workflow steps.
